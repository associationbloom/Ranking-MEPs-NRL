...
# Ranking MEPs present in the ENVI committee

Filter the data to get only MEPs in the ENVI committee
...
We create a table with the details of each vote for MEPs present in the ENVI commission
